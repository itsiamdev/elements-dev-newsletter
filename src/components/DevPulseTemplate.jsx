import { Email, Row, Column, ColumnLayouts, Heading, Paragraph, Button, Divider, Image, Html, Social, Menu } from '@unlayer/react-elements';
...
export default DevPulseTemplate;
